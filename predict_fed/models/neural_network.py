...
class NeuralNetwork(Model):
    ...
    def train(self, train_x, train_y):
       #assuming data is already preprocessed and normalized
        ...
        # Fit the model
        self.model.fit(train_x, train_y, batch_size=self.batch_size, epochs=150)   #batch_size is the number of samples per gradient update for training and epochs is the number of epochs to train the model
